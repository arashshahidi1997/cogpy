...
from cogpy.utils.sliding_core import running_blockwise_xr, running_reduce_xr

EPS = 1e-12


# Temporal measures moved to cogpy.measures.temporal.
...
def temporal_mean_laplacian(arr: np.ndarray) -> np.ndarray:
    ...
    Matches `cogpy.preprocess.channel_feature_functions.temporal_mean_laplacian`.
