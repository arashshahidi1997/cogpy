...
def multichannel_view(
    ...
    *,
    ...
    """
    Umbrella wrapper for :func:`cogpy.plot.multichannel_timeseries.multichannel_timeseries_view`
...
def add_time_hair(
    ...
    **attach_kwargs,
    ...
    This is a small umbrella wrapper around :func:`cogpy.plot.time_player.add_time_hair`
    ...
    >>> import numpy as np
    >>> from cogpy.plot.xarray_hv import add_time_hair
...
def add_click_hair(
    ...
    **attach_kwargs,
    ...
    This is an umbrella wrapper around :func:`cogpy.plot.time_player.add_axis_hair`.
...
def grid_movie_with_time_curve(
    ...
    *,
    ...
    >>> import numpy as np
    >>> import xarray as xr
    >>> from cogpy.plot.xarray_hv import grid_movie_with_time_curve
    >>> da = xr.DataArray(
