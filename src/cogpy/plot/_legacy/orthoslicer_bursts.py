...
:class:`cogpy.plot.orthoslicer_rangercopy.OrthoSlicerRanger`:
...
>>> from cogpy.plot.orthoslicer_bursts import OrthoSlicerRangerBursts
>>>
>>> pn.extension()
>>> hv.extension("bokeh")
>>>
...
from cogpy.plot.hv.orthoslicer import OrthoSlicerRanger, _clip_pair
...
def main() -> None:
    ...
    it can be used via ``python -m cogpy.plot.orthoslicer_bursts``.
    """
    from cogpy.datasets.tensor import make_flat_blob_dataset, detect_bursts_hmaxima
