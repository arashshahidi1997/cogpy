...
This module builds on :class:`cogpy.plot.orthoslicer_bursts.OrthoSlicerRangerBursts`
...
>>> from cogpy.plot.orthoslicer_bursts_timeseries import OrthoSlicerRangerBurstsTimeseries
>>>
>>> pn.extension()
>>> hv.extension("bokeh")
>>>
...
warnings.warn(
    ...
    "For new projects, use TensorScope (cogpy.tensorscope). "
...
from cogpy.plot.hv.orthoslicer import _clip_pair
from cogpy.plot.hv.multichannel_timeseries import multichannel_timeseries_view
...
class OrthoSlicerRangerBurstsTimeseries(OrthoSlicerRangerBursts):
    """
    Extends :class:`~cogpy.plot.orthoslicer_bursts.OrthoSlicerRangerBursts`
    ...
    def panel_app(self):
        """
        Panel app laid out like :meth:`~cogpy.plot.orthoslicer_bursts.OrthoSlicerRangerBursts.panel_app`
...
def main() -> None:
    ...
    it can be used via ``python -m cogpy.plot.orthoslicer_bursts_timeseries``.
    """
    from cogpy.datasets.tensor import make_flat_blob_dataset, detect_bursts_hmaxima
