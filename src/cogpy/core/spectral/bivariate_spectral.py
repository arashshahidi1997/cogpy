...
def multitaper_csd(y, axis=-1, NW=2, nfft=None, K_max=None, fs=1, detrend=False, n_fft_threads=cpu_count()):
    """
    Parameters
    ----------
    y: array (..., ch, time)
...
def multitaper_chd(y, axis=-1, NW=2, nfft=None, K_max=None, fs=1, detrend=False, n_fft_threads=cpu_count()):
    """
    Parameters
    ----------
    y: array
