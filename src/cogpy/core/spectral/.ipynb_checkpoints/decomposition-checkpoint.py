...
def scree_plot(pca:PCA, cutoff=.95, ax=plt.gca()):
    ...
    ax.set(xlabel='PC dim', ylabel='expl. var. ratio',
    ...
    ax2.hlines(cutoff, dim, pca.n_components_ + 10, colors='k', linestyles='--', alpha=.5) 
    ax2.set(xlim=[0, pca.n_components_])
    ax2.text(dim-1, 0.8 * cutoff, f'{100*cutoff}% explained variance',
