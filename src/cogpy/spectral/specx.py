...
def psdx(
    ...
    **kwargs,
    ...
    Wraps ``psd_welch`` or ``psd_multitaper`` from ``cogpy.spectral.psd``.
...
def coherencex(
    ...
    *,
    ...
    Wraps ``multitaper_fft`` + ``cogpy.spectral.bivariate.coherence``.
    """
...
def normalize_spectrogram(
    ...
    *,
    ...
    method : {"robust_zscore", "db"}
        ...
        via :func:`cogpy.preprocess.filtering.normalization.zscorex`.
    ...
    if method == "robust_zscore":
        from cogpy.preprocess.filtering.normalization import zscorex
