...
def spatial_coherence_profile(
    ...
    *,
    ...
    Use cogpy.spectral.multitaper.multitaper_fft and
    cogpy.spectral.bivariate.coherence internally.
    Do NOT call sys.path — all imports are from the cogpy env.
    """
    from cogpy.spectral.multitaper import multitaper_fft
    from cogpy.spectral.bivariate import coherence as _coherence
