...
def _input(input_dat, input_xml, input_badlabdel):
	sigx = ecog_io.from_file(input_dat, input_xml)
...
def main(input_dat, input_xml, input_badlabdel, output_interp):
	sigx, labels = _input(input_dat, input_xml, input_badlabdel)
