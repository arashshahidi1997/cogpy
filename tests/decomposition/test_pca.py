"""Tests for cogpy.decomposition.pca — varimax-rotated PCA."""
...
class TestVarimax:
    def test_output_shape(self, random_data):
        from cogpy.decomposition.pca import varimax_rotation
...
class TestHelpers:
    def test_pseudo_inverse_scaled(self):
        from cogpy.decomposition.pca import pseudo_inverse_scaled
    ...
    def test_redirect_loadings(self):
        from cogpy.decomposition.pca import redirect_loadings
    ...
    def test_sort_by_eigv(self):
        from cogpy.decomposition.pca import sort_by_eigv
    ...
    def test_simplicity_criterion(self):
        from cogpy.decomposition.pca import simplicity_criterion
