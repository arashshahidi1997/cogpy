...
def test_find_elbow():
    ...
    assert knee.knee_y == expected_output_y, f"Expected {expected_output_y}, but got {knee.knee_y}"
    assert knee.knee == expected_output_x, f"Expected {expected_output_x}, but got {knee.knee}"
